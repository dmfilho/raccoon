...
namespace raccoon
{
	...
	public:		
		 ...
		 */
		PathItemRole * containsNegationOfRole(RoleRealization* role, Instance* inst1, Instance* inst2, bool exactly);
		 ...
		 */
		PathItemConcept * containsNegationOfConcept(ConceptRealization* concept, Instance* inst, bool exactly);
