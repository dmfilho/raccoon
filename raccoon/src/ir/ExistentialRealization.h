 ...
 * \date 2017-09-03
 * \file
 * This file contains the declaration of the ExistentialRestriction class.
 */

#ifndef __RACCOON_IR_EXISTENTIALREALIZATION_H
#define __RACCOON_IR_EXISTENTIALREALIZATION_H
...
namespace raccoon
{
	class ExistentialRealization 
	 : public raccoon::ILiteralRealization
	{
	public:
		/**
		 * This is the value returned by the ExistentialRealization::type() method.
		 */
		 ...
		 * \brief Constructor
		 */
		ExistentialRealization(Literal& role, unsigned int var1r, unsigned int var2r, bool negr, Literal& concept, bool negc);
...
#endif // __RACCOON_IR_EXISTENTIALREALIZATION_H
