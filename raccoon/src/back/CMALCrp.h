 ...
 * \date 2015-02-17
 * \file
 * This file contains the declaration of the CM-ALC (with regularity and PURE reduction) reasoner class.
 */

#ifndef __RACCOON_BACK_CMALCrp_H
#define __RACCOON_BACK_CMALCrp_H
